...
vim.keymap.set('n', '<C-q>', '<C-v>', { desc = 'Remap visual block mode (Windows)' })
...
vim.api.nvim_create_augroup('CustomRIndent', { clear = true })
  ...
  { -- Highlight, edit, and navigate code
    ...
    opts = {
      ...
      highlight = {
        ...
        additional_vim_regex_highlighting = { 'ruby', 'r' },
      },
